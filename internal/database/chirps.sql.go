...
const deleteSingletonChirps = `-- name: DeleteSingletonChirps :exec
DELETE FROM chirps WHERE id = $1
`

func (q *Queries) DeleteSingletonChirps(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, deleteSingletonChirps, id)
	return err
}
